...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" YUDI ID [RED ID]"$i" |"
echo $i" |"$pu" FACEBOOK :"$ku" RED ID"$i" |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.Xx] [MR.S∆] [MR.Y]"$i" |"
echo $i" |"$cy" ~ [cyber] [%MR.S%] [yud]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 082319843611"$i" |"
echo $i" |"$pu" Contack Gmail :"$ku" yudisyaah23@gmail.com"$i" |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"──────────────────────────────── ─────"
...
sleep 2
echo $ku"WhatsApp :"$i" 082319843611"
echo $ku"Facebook :"$i" RED ID"
sleep 2
